...
# Implement this: VectorAdd() performs vector addition
# on two vectors and returns a
# vector
def VectorAdd(a, b):
    assert len(a) == len(b)
    newVector = []
...
# Implement this: VectorSub() performs vector subtraction
# on two vectors and returns a
# vector
def VectorSub(a, b):
    assert len(a) == len(b)
...
# Implement this: VectorMult() performs vector multiplication
